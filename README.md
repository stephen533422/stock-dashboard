...
A multi-stock dashboard of ~113 US equities across 10 sectors: cards with
...
- **Dashboard** — responsive card grid, live price/% change, inline sparklines, instant search, watchlist filter.
